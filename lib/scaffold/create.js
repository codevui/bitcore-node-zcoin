...
var BASE_PACKAGE = {
    description: 'A full Zcoin node build with Bitcore',
    repository: 'https://github.com/codevui/bitcore-node-zcoin',
    license: 'MIT',
    readme: 'README.md',
    dependencies: {
        'bitcore-lib-zcoin': 'git://github.com/codevui/bitcore-lib-zcoin.git',
        'bitcore-node-zcoin': 'git://github.com/codevui/bitcore-node-zcoin.git',
        //'insight-ui-zcoin': 'git://github.com/sn-ntu/insight-ui-zcoin.git',
        //'insight-api-zcoin': 'git://github.com/sn-ntu/insight-api-zcoin.git'
    }
};
...
function createConfigDirectory(options, configDir, isGlobal, done) {
    mkdirp(configDir, function (err) {
        ...
        try {
            fs.writeFileSync(configDir + '/bitcore-node-zcoin.json', configJSON);
            if (!isGlobal) {
...
function create(options, done) {
    ...
    async.series([
        function (next) {
            // Setup the the bitcore-node-zcoin directory and configuration
